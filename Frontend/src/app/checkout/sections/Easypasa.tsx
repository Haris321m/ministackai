...
export default function Easypasa() {
  ...
  return (
    <div className="bg-gradient-to-br from-white to-gray-100 dark:from-gray-800 dark:to-gray-900 shadow-2xl rounded-2xl p-6 w-full max-w-md mx-auto transition-all duration-500">
      {/* Title */}
      <h2 className="text-3xl font-extrabold text-center text-gray-900 dark:text-gray-100 mb-3">
        Easypaisa Payment Proof
      </h2>
      ...
      <div className="my-10">
        ...
        <p>
          Simply pay for your chosen plan through Easypaisa. Once you've paid,
          send us a screenshot of the payment confirmation. Our team will
          quickly verify it and activate your plan on your account within one
          hour, so you can start using the AI immediately.
        </p>
      ...
      <p className="text-center text-gray-600 dark:text-gray-400 mb-6">
        Upload your Easypaisa payment screenshot to confirm your payment.
      </p>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-6">
        ...
        <div className="relative flex flex-col items-center justify-center border-2 border-dashed border-blue-400 rounded-xl p-6 text-center hover:bg-blue-50 dark:hover:bg-gray-700 transition cursor-pointer">
          <input
            type="file"
            accept="image/*"
        ...
        <button
          type="submit"
          disabled={loading}
          className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white py-3 px-6 rounded-xl shadow-lg text-lg font-semibold transition transform hover:scale-105 active:scale-95 disabled:opacity-60"
        >
